## To analyze peak and decline from GCAM simulations for each basin across all scenarios 
# Hassan Niazi, April 2022
...
basin_names_all <- c("Adriatic Sea-Greece-Black Sea Coast" ,"Africa-East Central Coast" ,"Africa-Indian Ocean Coast" ,
                     "Africa-North Interior" ,
                     "Africa-North West Coast" ,
                     "Africa-Red Sea-Gulf of Aden Coast" ,
                     "Africa-South Interior" ,
                     "Africa-West Coast" ,
                     "Amazon" ,
                     "Amu Darya" ,
                     "Amur" ,
                     ...
                     "Baja California" ,
                     "Baltic Sea Coast" ,
                     "Bay of Bengal-North East Coast" ,
                     "Black Sea-North Coast" ,
                     "Black Sea-South Coast" ,
                     "Bo Hai-Korean Bay-North Coast" ,
                     "Brahamani" ,
                     "California River" ,
                     "Caribbean" ,
                     "Caribbean Coast" ,
                     "Caspian Sea-East Coast" ,
                     "Caspian Sea-South West Coast" ,
                     "Caspian Sea Coast" ,
                     "Cauvery" ,
                     "Central Iran" ,
                     "Central Patagonia Highlands" ,
                     "Chao Phraya" ,
                     "China Coast" ,
                     "Churchill" ,
                     ...
                     "North Argentina-South Atlantic Coast" ,
                     "North Borneo Coast" ,
                     ...
                     "Rio Lerma" ,
                     "Rio Verde" ,
                     "Russia-Barents Sea Coast" ,
                     "Russia-South East Coast" ,
                     "Sabarmati" ,
                     "Salinas Grandes" ,
                     "Salween" ,
                     "Sao Francisco" ,
                     "Saskatchewan-Nelson" ,
                     "Scandinavia-North Coast" ,
                     "Scheldt" ,
                     "Scotland" ,
                     "Seine" ,
                     "Senegal" ,
...
## all peak and decline bains grid plot 
full_data %>% 
...
# full historical data plus uncertainity bands (preferred)
...
g +  
  ...
  facet_wrap(~groundwater, scales = "free") +
  #scale_x_continuous(expand = c(0.0, 0), breaks = c(1990, 2000, 2010, 2020, 2030, 2040, 2050, 2060, 2070, 2080, 2090, 2100),                     labels = c("1990", "", "", "", "", "", "2050", "", "", "", "", "2100") ) + 
  scale_x_continuous(expand = c(0.0, 0), limits = c(1990, 2100), breaks = c(1990, 2050, 2100), labels = c( "1990",  "2050",  "2100"))  +
  theme_void()+
  theme_classic() +
  theme(legend.position="none",
        ...
        axis.title.y=element_text("Groundwater Withdrawals (km3/yr)"),
        #axis.line.x.bottom = element_blank(),
        #panel.border = element_blank(),
        #panel.grid=element_blank()
  ) -> allbasins_pnd

# ggsave("allbasinspnd_v1.png", plot= allbasins_pnd, width = 23, height = 13)


## uncertainty bands trimmed off 
g +  
  geom_ribbon(data = filter(g$data, year >=2020), aes(ymin = lo_quar, ymax = up_quar), fill = "dodgerblue", alpha = 0.5) +
  geom_ribbon(data = filter(g$data, year >=2020), aes(ymin = lo_dep, ymax = up_dep), alpha = 0.2) +
  geom_line(aes(y = med_dep), lwd = 1.25) +
  facet_wrap(~groundwater, scales = "free") +
  #scale_x_continuous(expand = c(0.0, 0), breaks = c(1990, 2000, 2010, 2020, 2030, 2040, 2050, 2060, 2070, 2080, 2090, 2100),                     labels = c("1990", "", "", "", "", "", "2050", "", "", "", "", "2100") ) + 
  scale_x_continuous(expand = c(0.0, 0), limits = c(1990, 2100), breaks = c(1990, 2050, 2100), labels = c( "1990",  "2050",  "2100"))  +
...
# ggsave("allbasinspnd_v2.png", plot= allbasins_pnd_v, width = 23, height = 13) #bands trimmed
# ggsave("allbasinspnd_v3.png", plot= allbasins_pnd_v, width = 23, height = 13) # until 2020
